...
<h3 align="center">FootballAnalyticsML</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/adlub/FootballAnalyticsML">View Demo</a>
    ·
...
2. Clone the repo
   ```sh
   git clone https://github.com/adlub/FootballAnalyticsML.git
   ```
...
See the [open issues](https://github.com/adlub/FootballAnalyticsML/issues) for a full list of proposed features (and known issues).
...
[license-url]: https://github.com/adlub/FootballAnalyticsML/blob/master/LICENSE.txt
